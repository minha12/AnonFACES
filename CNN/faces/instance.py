...
class RaFDInstance:
    ...
    def __init__(self, directory, filename, image_size, trim=24, top=24):
        ...
        self.image = imageio.imread( os.path.join(directory, filename) )
        ...
        #self.mask  = imageio.imread( os.path.join(directory, 'mask',  filename) )
...
class YaleInstance:
    ...
    def __init__(self, directory, filepath, image_size):
        ...
        self.image = imageio.imread( os.path.join(directory, filepath) )
